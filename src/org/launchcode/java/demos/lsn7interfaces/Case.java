...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Nuts", 0.50, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping2 = new Topping("Sprinkles", 0.25, new ArrayList<>(Arrays.asList("none")));
        Topping topping3 = new Topping("Chocolate Chips", 0.25, new ArrayList<>(Arrays.asList("dairy")));
